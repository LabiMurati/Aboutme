...
const StackItem = ({ icon,  description }) => (
...
const Stack = () => {
  ...
  const stackItems = [
    { icon: <FaHtml5 size={30} />, title: "HTML5"},
    { icon: <FaCss3Alt size={30} />, title: "CSS3" },
    { icon: <FaSass size={30} />, title: "Sass/SCSS" },
    { icon: <FaBootstrap size={30} />, title: "Bootstrap"},
    { icon: <Image src={tailIcon} alt="Tailwind CSS Logo" width={30} />, title: "Tailwind CSS" },
    { icon: <SiJquery size={30} />, title: "jQuery" },
    { icon: <FaJs size={30} />, title: "JavaScript"},
    { icon: <FaReact size={30} />, title: "React"},
    { icon: <SiNextdotjs size={30} />, title: "Next.js"},
    { icon: <FaWordpress size={30} />, title: "WordPress" },
    { icon: <Image src={githubIcon} alt="GitHub Logo" width={30} />, title: "Git" },
